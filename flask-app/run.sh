...
# Docker Tag
docker tag "****/terraform-flask-postgres-docker-example:test" "****/terraform-flask-postgres-docker-example:latest"
...
# Docker push
docker push "****/terraform-flask-postgres-docker-example:latest"
